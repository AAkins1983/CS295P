<?php
	// Each row is an array. Must have commas after each element. Event will happen in each row.
	$events = array (
				array(	'eventId'=>1,
						'userId'=>1,
	...
	//print_r($events);
	//echo ("4/2 and strtotime " . hasEvents(strtotime("2014-04-02 00:00:00")) . "<br/>");
	//echo ("4/2 " . hasEvents("2014-04-30 00:00:00"). "<br/>");
